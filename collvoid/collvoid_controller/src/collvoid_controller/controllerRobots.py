...
class ControllerRobots():
    ...
    def initialize(self):
        ...
        self.pub_init_guess = rospy.Publisher("initialpose", PoseWithCovarianceStamped,queue_size=10)
        self.pub_commands_robot = rospy.Publisher("/commands_robot", String, queue_size=10)
